...
function resetThemeSettings() {
    ...
    setCSSVariables(defaultSettings);
...
function getThemeSettingsFromInputs() {
    return {
        ...
        '--black-color': `rgba(0, 0, 0, ${document.querySelector('.black-depth').value / 100})`,
        '--white-color': `rgba(255, 255, 255, ${document.querySelector('.white-depth').value / 100})`,
        '--gray-color': `rgba(128, 128, 128, ${document.querySelector('.gray-depth').value / 100})`
    };
}
