          ...
          <section className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <Card>
              <CardContent className="p-6">
                <div className="mb-4 grid h-10 w-10 place-items-center rounded-xl bg-secondary text-foreground/60">
                  <Heart className="h-5 w-5" />
                </div>
                <h3 className="mb-2 font-semibold text-foreground">热爱与激情</h3>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="mb-2 font-semibold text-foreground">社区第一</h3>
                <p className="text-sm text-muted-foreground">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="mb-2 font-semibold text-foreground">开放包容</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <section className="text-center">
                <Card>
                  <CardContent className="p-8">
                    <h2 className="mb-4 text-3xl font-bold text-foreground">想来玩就来吧</h2>
