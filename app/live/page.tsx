                            ...
                            <div className="px-4 py-3 border-b border-black/10 dark:border-white/10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h2 className="text-slate-80 dark:text-white font-bold text-lg">播放列表</h2>
                                    </div>
    ...
    return (
        <>
            ...
            <style jsx>{`
                ...
                .scrollbar-custom::-webkit-scrollbar-thumb { background: linear-gradient(to bottom, #3b8f, #a855f6); border-radius: 10px; }
