...
export const metadata: Metadata = {
  ...
  description:
    "下载 EndlessPixel Minecraft 服务器最新客户端整合包。支持 26.2 最新版、26.1.2、26.1.1 、26.1、1.21.11、1.21.10、1.21.9、1.21.8、1.21.4 稳定版，包含 Fabric 模组包和优化配置。提供主分支和 Real 分支两种版本选择。",
  keywords: ["Minecraft下载", "模组包下载", "Fabric", "客户端下载", "26.2","26.1.2","26.1.1","26.1","1.21.11", "1.21.9", "1.21.8", "1.21.6", "1.21.4", "EndlessPixel", "整合包"],
  openGraph: {
