  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <Card key={i} className="rounded-xl border-border bg-card/60">
          <CardContent className="p-4">
            <div className="mb-2 h-4 w-16 animate-pulse rounded bg-muted-foreground/20" />
        ...
        <div className="mx-auto max-w-6xl">
          <Card className="border-destructive/30 bg-destructive/10">
            <CardContent className="p-8 text-center">
              ...
              <p className="mb-6 text-muted-foreground">{error ?? "未找到问题详情"}</p>
        ...
        <div className="mx-auto max-w-6xl space-y-8">
          ...
          <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
            <div className="space-y-2">
              ...
              <h1 className="text-3xl font-bold text-foreground md:text-4xl">问题详情</h1>
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-1 text-sm font-medium text-foreground/80">创建者</div>
                    <div className="truncate text-lg font-semibold text-foreground">
                      {issue.user.login}
                    </div>
                    <div className="mt-1 text-xs text-muted-foreground">问题报告者</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-xl border-border bg-card/80 shadow-sm backdrop-blur-sm">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-1 text-sm font-medium text-foreground/80">创建时间</div>
                    <div className="truncate text-lg font-semibold text-foreground">
            ...
            <Card className="rounded-xl border-border bg-card/80 shadow-sm backdrop-blur-sm">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-1 text-sm font-medium text-foreground/80">评论数</div>
                    <div className="truncate text-lg font-semibold text-foreground">
                      {issue.comments}
                    </div>
                    <div className="mt-1 text-xs text-muted-foreground">讨论数量</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-xl border-border bg-card/80 shadow-sm backdrop-blur-sm">
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="mb-1 text-sm font-medium text-foreground/80">状态</div>
                    <div className="truncate text-lg font-semibold text-foreground">
                      <Badge
          ...
          {issue.labels.length > 0 && (
            <Card className="rounded-xl border-border bg-card/80 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="mb-4 flex items-center gap-3">
                  <Tag className="h-5 w-5 text-muted-foreground" />
                  <h3 className="font-semibold text-foreground">标签</h3>
                </div>
            ...
            <CardContent>
              {issue.body ? (
                <div className="prose prose-sm max-w-none">
                  <div className="rounded-xl border-border bg-muted/50 p-6">
                    <ReactMarkdown
                        ...
                        code: ({ className, children }) => {
                          ...
                          return (
                            <code
                              className={
                                isBlock
                                  ? "block overflow-x-auto rounded-lg bg-muted p-3 text-sm"
                ...
                <div className="rounded-xl border-border bg-muted/50 py-12 text-center text-muted-foreground">
          ...
          {comments.length > 0 ? (
            <section>
              ...
              <div className="space-y-6">
                {comments.map((c) => (
                  <Card key={c.id} className="rounded-xl border-border bg-card/80 backdrop-blur-sm">
                    <CardContent className="p-6">
                      <div className="mb-4 flex items-start justify-between">
                        ...
                        <div className="text-xs text-muted-foreground/60">#{c.id}</div>
                      </div>
                      <div className="prose prose-sm max-w-none">
                        <div className="rounded-lg border-border bg-muted/50 p-4 text-foreground/80">
