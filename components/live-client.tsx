...
function LiveContent() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] bg-background transition-colors duration-300">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className="w-full lg:w-80">
            <div className="overflow-hidden rounded-2xl border border-foreground/8 bg-card shadow-sm">
              <div className="border-b border-foreground/8 px-4 py-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    {/* 竖条改为灰色 */}
                    <div className="h-5 w-1.5 rounded-full bg-foreground/40" />
                    <h2 className="text-lg font-bold text-foreground">播放列表</h2>
                  </div>
              ...
              <div className="scrollbar-custom max-h-[calc(100vh-280px)] min-h-75 overflow-y-auto p-2">
          ...
          <div className="flex-1">
            <div className="group relative">
              <div className="relative rounded-2xl border border-foreground/8 bg-black/5 p-2 shadow-sm dark:bg-black/20">
              ...
              <a
                ...
                className="mt-3 block w-full rounded-xl bg-foreground py-3 text-center font-medium text-background shadow-sm transition-all hover:bg-foreground/85 hover:shadow-md"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 block w-full rounded-xl bg-secondary py-2 text-center text-sm text-foreground/70 transition-all hover:bg-secondary/70"
              >
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  className="min-w-30 flex-1 rounded-xl bg-secondary py-2.5 text-sm font-medium text-foreground/70 transition-colors hover:bg-secondary/70"
                >
                  📋 复制B站链接
                </button>
                <button
      ...
      {/* ---------- Toast 提示 ---------- */}
      {copyTip && (
        <div className="fixed bottom-6 left-1/2 z-50 -translate-x-1/2 rounded-full border border-foreground/8 bg-card px-5 py-2.5 text-sm text-foreground shadow-lg backdrop-blur-sm transition-all duration-200">
          {copyTip}
        </div>
      )}
    </div>
...
export default function LiveClient() {
  return (
    <>
      <Suspense
        fallback={
          <div className="flex min-h-[calc(100vh-80px)] items-center justify-center text-lg text-muted-foreground">
            加载中...
          </div>
        }
      >
