...
export function TechStackSection() {
  const techCategories = [
    ...
    },
    {
      ...
      icon: Server,
      color: "text-red-600",
      technologies: ["Temurin Java 21", "Minecraft 1.21.8", "LeafCore", "Velocity", "Ubuntu Server 13.3.0-6ubuntu2~24.04"],
    },
  ]
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">
              ...
              21环境上，使用LeafCore核心在基于Linux buildd@lcy02-amd64-011 的 Ubuntu Server 13.3.0-6ubuntu2~24.04系统中为玩家提供稳定可靠的游戏体验。
            </p>
          </div>
        </div>
      </CardContent>
