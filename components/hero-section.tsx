...
// 修复：useRef从react引入，仅从framer-motion引入motion、useInView
...
export function HeroSection() {
  ...
  // 修复：useInView正确配置（amount=0.1 对应10%视口触发，once=true只执行一次）
    ...
    <section ref={heroRef} className="relative bg-linear-to-br from-slate-50 via-blue-50/40 to-emerald-50/60 dark:from-slate-900 dark:via-blue-950/30 dark:to-emerald-950/30 py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          {/* 替换<br /><br />为div，用py-6控制间距（和原两个br空白一致） */}
          <div className="py-6" />
          ...
          >
            {[
              ...
              { icon: Gamepad2, title: "原汁原味", description: "保持原始平衡", color: "text-blue-600", bgColor: "bg-blue-100 dark:bg-blue-900/30", gradient: "from-blue-500 to-cyan-500" },
              { icon: Heart, title: "宽松规则", description: "自由探索创造", color: "text-red-600", bgColor: "bg-red-100 dark:bg-red-900/30", gradient: "from-red-500 to-pink-500" },
              { icon: Users, title: "活跃社区", description: "友好的玩家", color: "text-purple-600", bgColor: "bg-purple-100 dark:bg-purple-900/30", gradient: "from-purple-500 to-violet-500" },
      ...
      {/* 替换<br /><br /><br /><br />为div，用py-16控制间距（和原四个br空白一致） */}
      <div className="py-16" />
      <ServerFeatures />
    </section>
  )
